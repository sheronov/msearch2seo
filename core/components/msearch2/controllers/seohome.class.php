 ...
 * @package msearch2
 */
class mSearch2SeoHomeManagerController extends modExtraManagerController
{
    ...
    public function initialize()
    {
        if (!class_exists('mSearch2Seo')) {
            require dirname(__DIR__) . '/model/msearch2/msearch2seo.class.php';
        }
    ...
    {
        $this->addJavascript($this->mSearch2->config['jsUrl'] . 'mgr/widgets/seoindex.form.js');
